...
{modelName: 'A simple plant (ver. 1)', modelURL: unloadedPhoto, difficulty: 3, tags: ['Flower', 'Living'], description: 'null', webLink: '/plant-1', time: '7-12 min'}, 
...
{modelName: 'Tall plant', modelURL: unloadedPhoto, difficulty: 7, tags: ['Flower', 'Living'], description: 'null', webLink: '/tall-plant', time: '15-25 min'}, 
...
{modelName: 'The Hexawing', modelURL: unloadedPhoto, difficulty: 5.5, tags: ['Air', 'Future vehicle'], description: 'With its hexagon-shaped wings, this could glide through the air and land smoothly as well.', webLink: '/hexawing', time: 'TBD'}, 
...
{modelName: 'Future Vehicle 1', modelURL: unloadedPhoto, difficulty: 6.5, tags: ['Air', 'Future vehicle', 'Recreational vehicle'], description: 'The very first model I came up with. Features a single upright tail jet and two engines that propel the vehicle forward.', webLink: '/hexawing', time: 'TBD'}, 
